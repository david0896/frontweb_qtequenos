          ...
          <SplideTrack className='h-[20rem] lg:h-auto'>
            <SplideSlide>
                <div className='relative'>
                  <Image width={1080} height={720} src="https://i.postimg.cc/5txc7ncb/banner-principal-de-qteque-os.webp" className='h-[20rem] lg:w-screen lg:h-full object-cover object-right-top' alt="Banner de tequeños en un plato"/>
                    ...
                    <div className=' px-5 mx-auto lg:w-9/12 lg:h-full grid grid-cols-1 lg:grid-cols-4'> 
                      ...
                      <div className='col-span-2 grid content-center'>
                        ...
                        <div className='flex justify-self-center'>
                          <button type="button" className=" w-fit font-bold text-white bg-[#f5884d] hover:bg-[#a3542a] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-3xl text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
