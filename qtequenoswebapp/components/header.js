...
export default function Header() {
    return (
        <header className="lg:w-9/12 mx-auto z-[99] lg:relative">          
            <nav className=" bg-transparent border-gray-200 dark:transparent">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                    <div className="flex flex-wrap items-center justify-between w-full lg:w-auto mb-2 lg:mb-0">
                    ...
                    <div className="flex items-center md:order-2">
                        <a href="#" className="text-gray-800 dark:text-white border-2 border-blue-700 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Acceder</a>
                        <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 border-2 border-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Registrase</a>
                    </div>
