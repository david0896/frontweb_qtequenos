    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4">
        <div className="col-span-2 px-4 lg:pl-[29%] lg:pr-10 py-10 grid lg:content-center space-y-8">
          ...
          <Link href="/store" className=" w-fit font-bold text-white bg-[#c21a7f] hover:bg-[#970b5f] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-3xl text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
