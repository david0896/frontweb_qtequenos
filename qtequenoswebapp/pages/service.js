    ...
    return (
        ...
        >
            ...
            <div className=" relative mb-[20rem]">
                ...
                <Image width={720} height={360} src="https://i.postimg.cc/ZK3hNpLF/mano-aguantando-un-paquete-de-teque-os.png" alt="mano con tequeños en un paquete" className="w-[15rem] lg:w-[30rem] h-[15rem] lg:h-[30rem] absolute bottom-0 lg:top-0 right-0 translate-y-[18rem] lg:translate-y-[5rem]  object-cover"/>
            </div>
        </Layout>
    )
}