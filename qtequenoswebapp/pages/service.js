...
export default function Service({shoppingCart}) {
                ...
                <div className="px-5 mt-10 mb-[6rem] mx-auto lg:w-9/12">
                    <div className="grid grid-cols-1 lg:grid-cols-4">
                        <div className=" col-span-2 space-y-5">
                            ...
                            <Link   
                                href='https://wa.me/584143187888?text=Hola,%20tengo%20un%20evento%20y%20quisiera%20contratar%20sus%20servicios%20'
                                className=' gap-2 mt-4 w-fit font-bold text-white bg-[#4ac959] hover:bg-[#3ca448] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-3xl text-sm px-5 py-2.5 text-center inline-flex items-center'
                            >
