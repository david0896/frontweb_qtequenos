...
const Maintenance = () => {
  return (
    <div>
        <div className="leading-normal tracking-normal text-white gradient bg-gray-800 w-10/12 mx-auto">
            <nav id="header" className="fixed w-10/12 mx-auto p-5 justify-between z-30 top-0 text-white">
            <div className="w-full  container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <ul className="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li className="mr-3">
                    <a className="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">link</a>
                    </li>
                    <li className="mr-3">
                    <a className="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">link</a>
                    </li>
